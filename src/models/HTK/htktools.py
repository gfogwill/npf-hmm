...
from src.paths import model_path, htk_misc_dir
...
def HERest(args, print_output=False):
...
def HRest(args, print_output=False):
    """ Runs HTK HERest program to calculate signal parameters.
        Args:
...
def HVite(args, print_output=False):
    """ Runs HTK HERest program to calculate signal parameters.
        Args:
            args (any): Path to configuration file.
            print_output (string): Path to script file to be used by HCopy.
...
def HInit(args, print_output=False):
    """ Runs HTK HERest program to calculate signal parameters.
        Args:
...
def HCompV(args, print_output=False):
...
def HHEd(args, print_output=False):
